...
const HERO_CONTENT = {
  ...
  // Puxando diretamente da pasta public/
  bg_image: "/hero.jpg", 
};
      ...
      <div className="relative z-10 w-full mt-[-100dvh] flex flex-col justify-end md:justify-center min-h-[100dvh]">
        ...
        <div className="w-full max-w-7xl mx-auto px-0 md:px-6 lg:px-8 pb-0 md:pb-12 md:pt-24 flex justify-center md:justify-start">
          <motion.div
            ...
            className="w-full md:max-w-2xl pt-6 pb-16 px-5 md:p-12 rounded-t-[2.5rem] md:rounded-[2.5rem] backdrop-blur-2xl bg-stone-950/80 md:bg-stone-950/40 border-t md:border border-amber-900/40 shadow-[0_-20px_50px_-15px_rgba(0,0,0,0.8)] md:shadow-2xl flex flex-col items-center md:items-start text-center md:text-left"
          >
