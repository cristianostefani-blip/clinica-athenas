...
// ==========================================
// Ajuste os nomes das fotos de acordo com o que você subiu na pasta public/
const galleryImages = [
  "/infra-1.jpg",
  "/infra-2.jpg",
  "/infra-3.jpg",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col justify-center">
            ...
            >
              <h2 className="text-amber-500 text-sm font-medium tracking-[0.2em] uppercase mb-4">
                O Refúgio
              </h2>
              <h3 className="text-4xl md:text-5xl lg:text-6xl font-serif text-orange-50 leading-tight mb-6">
                ...
                <span className="italic font-semibold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-700">cada detalhe.</span>
              </h3>
          ...
          <div className="relative w-full mt-8 lg:mt-0 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[400px] lg:max-w-[480px] group rounded-[2rem] shadow-[0_0_40px_rgba(0,0,0,0.5)] border border-amber-900/30 overflow-hidden bg-stone-900">
              
              {canScrollLeft && (
                <button
                  onClick={() => scroll("left")}
                  className="absolute left-3 top-1/2 -translate-y-1/2 z-20 text-amber-400 hover:text-amber-300 hover:scale-110 transition-all duration-300 drop-shadow-md outline-none"
                >
              ...
              {canScrollRight && (
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 z-20 text-amber-400 hover:text-amber-300 hover:scale-110 transition-all duration-300 drop-shadow-md outline-none"
                >
